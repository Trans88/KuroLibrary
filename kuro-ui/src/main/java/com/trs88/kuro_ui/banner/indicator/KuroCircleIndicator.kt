 ...
 * 圆形指示器
 */
class KuroCircleIndicator @JvmOverloads constructor(context: Context,attrs:AttributeSet? =null,defStyleAttr:Int =0):FrameLayout(context,attrs, defStyleAttr),KuroIndicator<FrameLayout> {
    companion object{
    ...
    init {
        mPointLeftRightPadding = KuroDisplayUtil.dp2px(5f, getContext().resources)
        mPointTopBottomPadding = KuroDisplayUtil.dp2px(15f, getContext().resources)
    }
